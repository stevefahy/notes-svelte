<script lang="ts">
  ...
  let error = $state({
    error_state: false,
    error_severity: "" as "" | "error" | "warning" | "info" | "success",
    message: "",
  });
  ...
  <div class={vCard("card")}>
    ...
    <div class={vCardText("card-content")}>
      <form novalidate onsubmit={submitHandler}>
        ...
        <div class="actions">
          <button
            class="btn-contained v-btn v-btn--elevated v-theme--myCustomLightTheme bg-secondary v-btn--density-default v-btn--size-default v-btn--variant-elevated contained medium"
            type="submit"
