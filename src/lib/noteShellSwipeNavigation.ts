...
/**
 * Horizontal swipe to mirror the footer Edit/View toggle (same transition as button).
 ...
 *
 * styles/note-shell.css: touch-action pan-y on the shell.
 */
