...
export type DeleteNotebook =
  | { error: string; success?: never; notebook_deleted?: never; server_response?: never }
  | { error?: never; success: boolean; notebook_deleted: string; server_response: unknown }
...
export type MoveNotes =
  | { success?: never; notes_moved?: never; server_response?: never; error: string }
  | { success: boolean; notes_moved: string[]; server_response: unknown; error?: never }
